...
**Decoded Info:**
- **Project:** REMOVED_JWT.supabase.co
...
1. Visit: https://supabase.com/dashboard/project/REMOVED_JWT/settings/api
...
1. Go to: https://supabase.com/dashboard/project/REMOVED_JWT/logs/explorer
